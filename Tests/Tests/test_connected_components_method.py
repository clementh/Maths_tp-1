...
# Unitary tests for the connected_components method from the Graph class #
# Version 1                                                              #
# Author : O. Bouillot                                                   #
# Creation : 22/11/15                                                    #
...
class TestConnectedComponents(unittest.TestCase):
    """ Class which is a set of unitary tests of the connected_components
    ...
    def test_1_of_connected_components(self):
        """ Test the return value of the connected_components method from the Graph class """
        connected_components = self.__graph_2.connected_components()
        self.assertEqual(len(connected_components), 1,
                         msg = "La méthode connected_components ne renvois " + \
                               "pas le bon nombre de composantes connexes...")
        self.assertSetEqual(set(connected_components[0]), set(['a', 'b', 'c', 'd', 'e', 'f']),
                            msg = "La méthode connected_components ne renvois " + \
                                  "pas le bon résultat...")

    def test_2_of_connected_components(self):
        """ Test the return value of the connected_components method from the Graph class """
        connected_components = self.__graph_3.connected_components()
        self.assertEqual(len(connected_components), 1,
                         msg = "La méthode connected_components ne renvois " + \
                               "pas le bon nombre de composantes connexes...")
        self.assertSetEqual(set(connected_components[0]), \
                            set(['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', \
                              'm', 'n']),
                            msg = "La méthode connected_components ne renvois " + \
                                  "pas le bon résultat...")

    def test_3_of_connected_components(self):
        """ Test the return value of the connected_components method from the Graph class """
        connected_components = self.__graph_4.connected_components()
        self.assertEqual(len(connected_components), 1,
                         msg = "La méthode connected_components ne renvois " + \
                               "pas le bon nombre de composantes connexes...")
        self.assertSetEqual(set(connected_components[0]), \
    ...
    def test_4_of_connected_components(self):
        """ Test the return value of the connected_components method from the Graph class """
        connected_components = self.__graph_5.connected_components()
        self.assertEqual(len(connected_components), 3,
                         msg = "La méthode connected_components ne renvois " + \
                               "pas le bon nombre de composantes connexes...")
        self.assertIn(set(connected_components[0]), \
                      [set(['a1', 'b1', 'c1', 'd1', 'e1', 'f1']), \
                       set(['a2', 'b2', 'c2', 'd2', 'e2', 'f2', 'g2', 'h2', 'i2', 'j2', \
                            'k2', 'l2', 'm2', 'n2']), \
                       set(['a3', 'b3', 'c3', 'd3', 'e3', 'f3', 'g3', 'h3'])], \
                      msg = "La méthode connected_components ne renvois " + \
                            "pas le bon résultat...")
        self.assertIn(set(connected_components[1]), \
                      [set(['a1', 'b1', 'c1', 'd1', 'e1', 'f1']), \
                       set(['a2', 'b2', 'c2', 'd2', 'e2', 'f2', 'g2', 'h2', 'i2', 'j2', \
                            'k2', 'l2', 'm2', 'n2']), \
                       set(['a3', 'b3', 'c3', 'd3', 'e3', 'f3', 'g3', 'h3'])], \
                      msg = "La méthode connected_components ne renvois " + \
                            "pas le bon résultat...")
        self.assertIn(set(connected_components[2]), \
                      [set(['a1', 'b1', 'c1', 'd1', 'e1', 'f1']), \
                       set(['a2', 'b2', 'c2', 'd2', 'e2', 'f2', 'g2', 'h2', 'i2', 'j2', \
                            'k2', 'l2', 'm2', 'n2']), \
                       set(['a3', 'b3', 'c3', 'd3', 'e3', 'f3', 'g3', 'h3'])], \
                      msg = "La méthode connected_components ne renvois " + \
                            "pas le bon résultat...")
        self.assertNotEqual(set(connected_components[0]), set(connected_components[1]),
                            msg = "La méthode connected_components renvois deux fois la même " + \
                                  "même composante connexe...")
        self.assertNotEqual(set(connected_components[0]), set(connected_components[2]),
                            msg = "La méthode connected_components renvois deux fois la même " + \
                                  "même composante connexe...")
        self.assertNotEqual(set(connected_components[1]), set(connected_components[2]),
                            msg = "La méthode connected_components renvois deux fois la même " + \
                                  "même composante connexe...")
    ...
    def test_if_there_is_a_docstring(self):
        ...
        self.assertNotEqual(Graph.connected_components.__doc__, '',
                            msg = "La méthode connected_components de la classe "+ \
                                  " Graph se devrait de possèder une docstring....")
        self.assertGreater(len(Graph.connected_components.__doc__.replace(' ', '')), 15,
    ...
    def test_the_parameters(self):
        ...
        self.assertEqual(inspect.getargspec(Graph.connected_components)[0],
                         ['self'],
                         msg = "La méthode connected_components ne possède pas " + \
                               "la bonne signature...")
        self.assertEqual(inspect.getargspec(Graph.connected_components)[1], None,
                         msg = "La méthode connected_components ne possède pas " + \
                               "la bonne signature...")
        self.assertEqual(inspect.getargspec(Graph.connected_components)[2], None,
                         msg = "La méthode connected_components ne possède pas  " + \
                               "la bonne signature...")
        self.assertEqual(inspect.getargspec(Graph.connected_components)[3], None,
                         msg = "La méthode connected_components ne possède pas  " + \
                               "la bonne signature...")
